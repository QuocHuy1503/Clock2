            ...
            if (!isset($_SESSION['email'])) {
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                        ...
                        <li><a class="dropdown-item orange-hover" href="../profile/index.php?email=<?=$_SESSION['email']?>">My account</a></li>
                        <li><a class="dropdown-item orange-hover" href="../cart/index.php">My cart</a></li>
                        <li><a class="dropdown-item orange-hover" href="../cart/History.php">Order history</a></li>
                    </ul>
                </div>
