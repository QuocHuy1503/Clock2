    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form class="row">
                        <div class="form-group  col-md-4">
                            <label class="control-label">Order ID (If not entered, it will be automatically detected)</label>
                ...
                <a class="btn btn-cancel" href="../cart/table-data-oder.php">Hủy bỏ</a>
            </div>
</main>
