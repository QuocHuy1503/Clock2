                            ...
                            <tbody>
                              ...
                              ?>
                                <tr>
                                    ...
                                    <td><?= $category['name']?></td>
                                    <td>
                                        <a class="btn btn-primary btn-sm trash" href ="destroy.php?id=<?= $category['id']?>" title="Xóa">
                                            <i class="fas fa-trash-alt"></i>
                                          </a>
                                        <a class="btn btn-primary btn-sm edit" type="button" href="edit.php?id=<?= $category['id'] ?>
