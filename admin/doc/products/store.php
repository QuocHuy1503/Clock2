...
$sql = "INSERT INTO clock
        (clock_name, publication_year, quantity, price, item_status, category_id, description, image) 
        VALUES ('$clock_name', '$publication_year', '$quantity', '$price', '$item_status', '$category_id', '$description', '$image')";
