...
$sql = "SELECT *, categories.name as category_name, categories.id as cate_id FROM watch INNER JOIN categories ON watch.category_id = categories.id ORDER BY watch_id ASC";
