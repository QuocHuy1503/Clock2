...
$sql = "SELECT *, categories.name as category_name, categories.id as cate_id FROM clock INNER JOIN categories ON clock.category_id = categories.id ORDER BY clock_id ASC";
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr>
                                    ...
                                    <td><a href ="destroy.php?id<?= $item['clock_id']?>" class="btn btn-primary btn-sm trash" title="Xóa">
